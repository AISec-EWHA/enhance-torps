...
USERMODEL=$8
NUM_SAMPLES=$9
TRACEFILE=$BASE_DIR/in/2016-05-15-user.traces.pickle
LOGLEVEL="INFO"
PATH_ALG="tor"

EXP_NAME=$USERMODEL.$DATE_RANGE.$ADV_GUARD_BW-$NUM_ADV_GUARDS-$ADV_EXIT_BW-$ADV_TIME-adv
NSF_DIR="./out/network-state-2026-05-01/"
